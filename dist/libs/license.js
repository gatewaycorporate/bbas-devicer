// ────────────────────────────────────────────────────────────
//  Polar.js license validation for bbas-devicer
...
export const POLAR_ORGANIZATION_ID = 'fbac0cf6-b4b2-450c-a47a-191f7e57f650';
/**
 * Polar benefit IDs that identify each paid tier.
 * All bbas-devicer plugins share the same organisation — paste the benefit
 * IDs once and both libraries use them.
 */
 ...
 */
export function evictLicenseCache(key) {
